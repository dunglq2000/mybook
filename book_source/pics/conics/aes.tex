...
\begin{tikzpicture}[node distance=2cm]
    ...
    \node [block, below of=r1, align=justify] (r2) {Substitute bytes \\ Shift rows \\ Mix columns \\ Add row key};
    ...
    \node [block, below of=r9, align=justify] (r10) {Substitute bytes \\ Shift rows \\ Mix columns \\ Add row key};
